...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        if self.pooling == "maxpool":
            pool_forward = conv_relu_maxpool_forward
            pool_backward = conv_relu_maxpool_backward
        else:
            raise ValueError('Only max pooling is supported in this implementation.')

        # Forward pass
        out1, cache1 = pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        dX, dW1, db1 = pool_backward(dout1, cache1)
